...
void copyFiles() {
   ...
   TFile *fin1 = new TFile("histos.root");
   TFile *fin2 = new TFile("histos_new.root");
   TDirectory* a0 = fin1->Get("data247324");
   TDirectory* a1 = fin1->Get("PythiaMonash");
   TDirectory* a2 = fin1->Get("PythiaZ2Star");
   TDirectory* a3 = fin2->Get("PythiaMBR");
   TFile *f = new TFile("hist_merge.root","recreate");
